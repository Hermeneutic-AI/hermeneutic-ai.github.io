...
monitors:
  - label: AI
    src: https://victorshammas.com/embeds/ai-monitor/
  - label: Space
...
Use the tabs to move between feeds. Each is meant as an interpretive log rather than a raw wire — an attempt to read the news the way a fieldworker reads a site: attentively, and over time.
